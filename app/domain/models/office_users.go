...
// OneG returns a single officeUser record from the query using the global executor.
func (q officeUserQuery) OneG(ctx context.Context) (*OfficeUser, error) {
	return q.One(ctx, boil.GetContextDB())
}

// OneGP returns a single officeUser record from the query using the global executor, and panics on error.
func (q officeUserQuery) OneGP(ctx context.Context) *OfficeUser {
...
// OneP returns a single officeUser record from the query, and panics on error.
func (q officeUserQuery) OneP(ctx context.Context, exec boil.ContextExecutor) *OfficeUser {
...
// AllG returns all OfficeUser records from the query using the global executor.
func (q officeUserQuery) AllG(ctx context.Context) (OfficeUserSlice, error) {
	return q.All(ctx, boil.GetContextDB())
}

// AllGP returns all OfficeUser records from the query using the global executor, and panics on error.
func (q officeUserQuery) AllGP(ctx context.Context) OfficeUserSlice {
...
// AllP returns all OfficeUser records from the query, and panics on error.
func (q officeUserQuery) AllP(ctx context.Context, exec boil.ContextExecutor) OfficeUserSlice {
...
// CountG returns the count of all OfficeUser records in the query using the global executor
func (q officeUserQuery) CountG(ctx context.Context) (int64, error) {
	return q.Count(ctx, boil.GetContextDB())
}

// CountGP returns the count of all OfficeUser records in the query using the global executor, and panics on error.
func (q officeUserQuery) CountGP(ctx context.Context) int64 {
...
// CountP returns the count of all OfficeUser records in the query, and panics on error.
func (q officeUserQuery) CountP(ctx context.Context, exec boil.ContextExecutor) int64 {
...
func (q officeUserQuery) ExistsG(ctx context.Context) (bool, error) {
	return q.Exists(ctx, boil.GetContextDB())
}

// ExistsGP checks if the row exists in the table using the global executor, and panics on error.
func (q officeUserQuery) ExistsGP(ctx context.Context) bool {
...
func (q officeUserQuery) ExistsP(ctx context.Context, exec boil.ContextExecutor) bool {
...
// SetOfficeG of the officeUser to the related item.
// Sets o.R.Office to related.
// Adds o to related.R.OfficeUsers.
// Uses the global database handle.
func (o *OfficeUser) SetOfficeG(ctx context.Context, insert bool, related *Office) error {
	return o.SetOffice(ctx, boil.GetContextDB(), insert, related)
}

// SetOfficeP of the officeUser to the related item.
// Sets o.R.Office to related.
// Adds o to related.R.OfficeUsers.
// Panics on error.
func (o *OfficeUser) SetOfficeP(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Office) {
	if err := o.SetOffice(ctx, exec, insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetOfficeGP of the officeUser to the related item.
// Sets o.R.Office to related.
// Adds o to related.R.OfficeUsers.
// Uses the global database handle and panics on error.
func (o *OfficeUser) SetOfficeGP(ctx context.Context, insert bool, related *Office) {
...
// SetUserG of the officeUser to the related item.
// Sets o.R.User to related.
// Adds o to related.R.OfficeUsers.
// Uses the global database handle.
func (o *OfficeUser) SetUserG(ctx context.Context, insert bool, related *User) error {
	return o.SetUser(ctx, boil.GetContextDB(), insert, related)
}

// SetUserP of the officeUser to the related item.
// Sets o.R.User to related.
// Adds o to related.R.OfficeUsers.
// Panics on error.
func (o *OfficeUser) SetUserP(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) {
	if err := o.SetUser(ctx, exec, insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetUserGP of the officeUser to the related item.
// Sets o.R.User to related.
// Adds o to related.R.OfficeUsers.
// Uses the global database handle and panics on error.
func (o *OfficeUser) SetUserGP(ctx context.Context, insert bool, related *User) {
...
// FindOfficeUserG retrieves a single record by ID.
func FindOfficeUserG(ctx context.Context, iD string, selectCols ...string) (*OfficeUser, error) {
	return FindOfficeUser(ctx, boil.GetContextDB(), iD, selectCols...)
}

// FindOfficeUserP retrieves a single record by ID with an executor, and panics on error.
func FindOfficeUserP(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) *OfficeUser {
	retobj, err := FindOfficeUser(ctx, exec, iD, selectCols...)
	if err != nil {
		panic(boil.WrapErr(err))
	}
...
// FindOfficeUserGP retrieves a single record by ID, and panics on error.
func FindOfficeUserGP(ctx context.Context, iD string, selectCols ...string) *OfficeUser {
	retobj, err := FindOfficeUser(ctx, boil.GetContextDB(), iD, selectCols...)
	if err != nil {
		panic(boil.WrapErr(err))
	}
...
func (o *OfficeUser) InsertG(ctx context.Context, columns boil.Columns) error {
	return o.Insert(ctx, boil.GetContextDB(), columns)
}

// InsertP a single record using an executor, and panics on error. See Insert
// for whitelist behavior description.
func (o *OfficeUser) InsertP(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) {
...
func (o *OfficeUser) InsertGP(ctx context.Context, columns boil.Columns) {
...
// UpdateG a single OfficeUser record using the global executor.
// See Update for more documentation.
func (o *OfficeUser) UpdateG(ctx context.Context, columns boil.Columns) (int64, error) {
	return o.Update(ctx, boil.GetContextDB(), columns)
}

// UpdateP uses an executor to update the OfficeUser, and panics on error.
// See Update for more documentation.
func (o *OfficeUser) UpdateP(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) int64 {
...
// UpdateGP a single OfficeUser record using the global executor. Panics on error.
// See Update for more documentation.
func (o *OfficeUser) UpdateGP(ctx context.Context, columns boil.Columns) int64 {
...
func (q officeUserQuery) UpdateAllP(ctx context.Context, exec boil.ContextExecutor, cols M) int64 {
...
func (q officeUserQuery) UpdateAllG(ctx context.Context, cols M) (int64, error) {
	return q.UpdateAll(ctx, boil.GetContextDB(), cols)
}

// UpdateAllGP updates all rows with the specified column values, and panics on error.
func (q officeUserQuery) UpdateAllGP(ctx context.Context, cols M) int64 {
...
// UpdateAllG updates all rows with the specified column values.
func (o OfficeUserSlice) UpdateAllG(ctx context.Context, cols M) (int64, error) {
	return o.UpdateAll(ctx, boil.GetContextDB(), cols)
}

// UpdateAllGP updates all rows with the specified column values, and panics on error.
func (o OfficeUserSlice) UpdateAllGP(ctx context.Context, cols M) int64 {
...
func (o OfficeUserSlice) UpdateAllP(ctx context.Context, exec boil.ContextExecutor, cols M) int64 {
...
func (o *OfficeUser) UpsertG(ctx context.Context, updateColumns, insertColumns boil.Columns) error {
	return o.Upsert(ctx, boil.GetContextDB(), updateColumns, insertColumns)
}

// UpsertGP attempts an insert, and does an update or ignore on conflict. Panics on error.
func (o *OfficeUser) UpsertGP(ctx context.Context, updateColumns, insertColumns boil.Columns) {
...
func (o *OfficeUser) UpsertP(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) {
...
// DeleteG deletes a single OfficeUser record.
// DeleteG will match against the primary key column to find the record to delete.
func (o *OfficeUser) DeleteG(ctx context.Context) (int64, error) {
	return o.Delete(ctx, boil.GetContextDB())
}

// DeleteP deletes a single OfficeUser record with an executor.
// DeleteP will match against the primary key column to find the record to delete.
// Panics on error.
func (o *OfficeUser) DeleteP(ctx context.Context, exec boil.ContextExecutor) int64 {
...
// DeleteGP deletes a single OfficeUser record.
// DeleteGP will match against the primary key column to find the record to delete.
// Panics on error.
func (o *OfficeUser) DeleteGP(ctx context.Context) int64 {
...
func (q officeUserQuery) DeleteAllG(ctx context.Context) (int64, error) {
	return q.DeleteAll(ctx, boil.GetContextDB())
}

// DeleteAllP deletes all rows, and panics on error.
func (q officeUserQuery) DeleteAllP(ctx context.Context, exec boil.ContextExecutor) int64 {
...
func (q officeUserQuery) DeleteAllGP(ctx context.Context) int64 {
...
func (o OfficeUserSlice) DeleteAllG(ctx context.Context) (int64, error) {
	return o.DeleteAll(ctx, boil.GetContextDB())
}

// DeleteAllP deletes all rows in the slice, using an executor, and panics on error.
func (o OfficeUserSlice) DeleteAllP(ctx context.Context, exec boil.ContextExecutor) int64 {
...
func (o OfficeUserSlice) DeleteAllGP(ctx context.Context) int64 {
...
func (o *OfficeUser) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("models: no OfficeUser provided for reload")
	}
...
func (o *OfficeUser) ReloadP(ctx context.Context, exec boil.ContextExecutor) {
...
func (o *OfficeUser) ReloadGP(ctx context.Context) {
...
func (o *OfficeUserSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("models: empty OfficeUserSlice provided for reload all")
	}
...
// and overwrites the original object slice with the newly updated slice.
// Panics on error.
func (o *OfficeUserSlice) ReloadAllP(ctx context.Context, exec boil.ContextExecutor) {
...
// and overwrites the original object slice with the newly updated slice.
// Panics on error.
func (o *OfficeUserSlice) ReloadAllGP(ctx context.Context) {
...
// OfficeUserExistsG checks if the OfficeUser row exists.
func OfficeUserExistsG(ctx context.Context, iD string) (bool, error) {
	return OfficeUserExists(ctx, boil.GetContextDB(), iD)
}

// OfficeUserExistsP checks if the OfficeUser row exists. Panics on error.
func OfficeUserExistsP(ctx context.Context, exec boil.ContextExecutor, iD string) bool {
	e, err := OfficeUserExists(ctx, exec, iD)
	if err != nil {
		panic(boil.WrapErr(err))
	}
...
// OfficeUserExistsGP checks if the OfficeUser row exists. Panics on error.
func OfficeUserExistsGP(ctx context.Context, iD string) bool {
	e, err := OfficeUserExists(ctx, boil.GetContextDB(), iD)
	if err != nil {
		panic(boil.WrapErr(err))
	}
