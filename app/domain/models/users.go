...
func (o *User) AddOfficeUsersG(ctx context.Context, insert bool, related ...*OfficeUser) error {
...
// Sets related.R.User appropriately.
// Panics on error.
func (o *User) AddOfficeUsersP(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*OfficeUser) {
...
func (o *User) AddOfficeUsersGP(ctx context.Context, insert bool, related ...*OfficeUser) {
