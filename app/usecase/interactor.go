...
type Interactor interface {
	...
	SyncSamples(ctx context.Context, offset int64, samples []*SampleCopy) error
}
...
func (i *interactor) SyncSamples(ctx context.Context, offset int64, samples []*SampleCopy) (err error) {
