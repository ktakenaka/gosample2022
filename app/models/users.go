...
func (o *User) OfficeUsers(mods ...qm.QueryMod) officeUserQuery {
	...
	queryMods = append(queryMods,
		qm.Where("`office_users`.`user_id`=?", o.ID),
	)
...
func (userL) LoadOfficeUsers(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		...
		qm.WhereIn(`office_users.user_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *User) AddOfficeUsers(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*OfficeUser) error {
	var err error
