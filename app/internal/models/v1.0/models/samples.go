...
var SampleWhere = struct {
	...
	ID:        whereHelperuint64{field: "`samples`.`id`"},
...
var (
	sampleAllColumns            = []string{"id", "title", "category", "memo", "date", "amount", "created_at", "updated_at"}
	sampleColumnsWithoutDefault = []string{"title", "category", "memo", "date", "amount"}
	sampleColumnsWithDefault    = []string{"id", "created_at", "updated_at"}
